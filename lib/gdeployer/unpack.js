...
Unpack.prototype = {
    ...
    onUnzip: function()
    {
        this.unzip.fileExtracted
            ...
            : evento.trigger("error", "Cannot extract archive to version path: "+this.request.versionPath);
    },
    ...
    {
        evento.trigger("success", "Archive extracted to: "+this.request.versionPath);
        evento.trigger("unpack");
    },
