...
Config.prototype = {
    ...
    addToRequest: function()
    {
        ...
        this.request.exportVersionPath = this.getExportVersionPath();

        evento.trigger("success", "Configuration loaded");
    ...
    getExportVersionPath: function()
    {
        return path.resolve(this.request.exportVersion);
    },
