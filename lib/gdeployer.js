...
var chown           = require("./gdeployer/chown")
...
function Gdeployer(){
    ...
    evento.on("EVENT_BEFORE",  this.changeFileOwner.bind(this))
    evento.on("EVENT_CHOWN",   this.runSymlinkTask.bind(this))
...
Gdeployer.prototype = {
    ...
    changeFileOwner: function()
    {
        chown.request = this.request
        chown.run()
    },
