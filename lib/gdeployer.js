...
function Gdeployer(){
    ...
    evento.on("INFORMER_ERROR",   _.bind(informer.error,   informer));
    evento.on("INFORMER_SUCCESS", _.bind(informer.success, informer));
    evento.on("INFORMER_INFO",    _.bind(informer.info,    informer));
    evento.on("INFORMER_WARNING", _.bind(informer.warning, informer));
    evento.on("INFORMER_LOADING", _.bind(informer.loading, informer));
    ...
    evento.on("after",   _.bind(this.cleanup,        this));
    evento.on("cleanup", _.bind(this.finish,         this));
};
